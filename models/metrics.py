# from: https://github.com/WangLibo1995/GeoSeg/blob/main/tools/metric.py
...
class Evaluator(object):
    ...
    def add_batch(self, gt_image, pre_image):
        assert gt_image.shape == pre_image.shape, 'pre_image shape {}, gt_image shape {}'.format(pre_image.shape,
                                                                                                 gt_image.shape)
        idxs = gt_image != self.ignore_index
        self.confusion_matrix += self._generate_matrix(gt_image[idxs], pre_image[idxs])
