# from: https://github.com/WangLibo1995/GeoSeg/blob/main/geoseg/models/FTUNetFormer.py
...
class Decoder(nn.Module):
    ...
    def forward(self, encoder_hidden_states):#, h, w):

        if self.do_ft:
            encoder_hidden_states = self.ft.transform_features(encoder_hidden_states)

        res1, res2, res3, res4 = encoder_hidden_states
...
def ft_unetformer(pretrained=True, num_classes=6, freeze_stages=-1, decoder_channels=256,
                  weight_path='models/decoders/dcfam/pretrained_weights/stseg_base.pth'):
