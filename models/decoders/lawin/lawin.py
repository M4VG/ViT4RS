#--------------------------------------------------------------------------------#
# DISCLAIMER: This code was adapted from: https://github.com/yan-hao-tian/lawin. #
#--------------------------------------------------------------------------------#
...
class BaseDecodeHead(nn.Module): #, metaclass=ABCMeta):
	...
	def __init__(self, cfg):
		...
		self._init_inputs(cfg['in_channels'], cfg['in_index'], cfg['input_transform'])
		# self.channels = cfg['channels']
		self.num_classes = cfg['num_classes']
		self.dropout_ratio = cfg['dropout_ratio']
		self.conv_cfg = None
...
class LAWINHead(BaseDecodeHead):
	...
	def __init__(self, cfg):
		...
		super(LAWINHead, self).__init__(cfg)

		self.depth = cfg['depth']
		self.concat_fuse = cfg['concat_fuse']
